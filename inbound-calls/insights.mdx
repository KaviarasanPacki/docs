...
After an inbound call, Callupgrade.ai provides transcripts, analytics, and possible automation triggers.
...
- In your Callupgrade.ai dashboard, go to **Calls** or **History**.
